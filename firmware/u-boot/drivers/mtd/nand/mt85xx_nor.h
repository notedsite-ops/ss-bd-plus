...
//-----------------------------------------------------------------------------
#define SFLASH_POLLINGREG_COUNT     5000000
#define SFLASH_WRITECMD_TIMEOUT     1000000
#define SFLASH_WRITEBUSY_TIMEOUT    5000000
#define SFLASH_ERASESECTOR_TIMEOUT  2000000
#define SFLASH_CHIPERASE_TIMEOUT    5000000
...
#ifdef BD_NOR_ENABLE
#define SFLASH_MEM_BASE         ((UINT32)0x60000000)//mmu off
#define SFLASH_REG_BASE         ((UINT32)(0x70000000 + 0x11000))
#else
...
{                                           \
  SFLASH_WRITE32(0x70008718, 0x0);          \
  SFLASH_WRITE32(0x70008718, 0x2);          \
  SFLASH_WRITE32(0x70008718, 0x0);          \
}
...
{                                                         \
  SFLASH_WRITE32(0x7000871C, src);                        \
  SFLASH_WRITE32(0x70008720, deststart);                  \
  SFLASH_WRITE32(0x70008724, deststart+len);              \ 
}

// DMA Trigger
#define SFLASH_DMA_START                    \
{											\
  SFLASH_WRITE32(0x70008718, 0x05);			\
}

// DMA Completion Check
#define SFLASH_DMA_IS_COMPLETED            (0x0 == (SFLASH_READ32(0xFD008718) & 0x1))
