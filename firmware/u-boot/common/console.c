...
#define T64B_GET_LOW()	BIM_READ32(REG_RW_T64b_LO_0)
    ...
    #define TIMER_INTERVAL      (UINT32)(756*1000000/4/1000)    //(189000000 / 1000)
#elif (CONFIG_CHIP_VER_CURR == CONFIG_CHIP_VER_MT8550)
    #define TIMER_INTERVAL      (UINT32)(796.5*1000000/4/1000)
#elif (CONFIG_CHIP_VER_CURR == CONFIG_CHIP_VER_MT8555)
    #define TIMER_INTERVAL      (UINT32)(297*1000000/1000)
#elif (CONFIG_CHIP_VER_CURR == CONFIG_CHIP_VER_MT8560)
    #define TIMER_INTERVAL      (UINT32)(288*1000000/1000)
#elif (CONFIG_CHIP_VER_CURR == CONFIG_CHIP_VER_MT8561)
    #define TIMER_INTERVAL      (UINT32)(27*1000000/1000/(BIM_READ32(REG_BIM_T64b_TI_0)+1))
...
void puts(const char *s)
{
...
#if LOG_WITH_TIMESTAMP
  {
	...
	r = T64B_GET_LOW();
	ms = r / TIMER_INTERVAL;
	//_divide(r, TIMER_INTERVAL, &ms, NULL);

    ss = ms / 1000; ms %= 1000;
    //_divide(ms, 1000, &ss, &ms);
    mm = ss / 60; ss %= 60;
    //_divide(ss, 60, &mm, &ss);
    hh = mm / 60; mm %= 60;
    //_divide(mm, 60, &hh, &mm);
    hh %= 100;
    //_divide(hh, 100, NULL, &hh);
